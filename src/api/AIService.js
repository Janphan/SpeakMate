...
Simulate an IELTS Speaking Part 1 interview with a learner at Band ${level} level.
The topic is: "${topic}"
Ask one question at a time. Use simple, natural language appropriate for Band ${level}.
Wait for the user's answer before continuing.
Start the interview immediately with a friendly greeting and the first question.
    `;
